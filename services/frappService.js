...
const FRAPP_API_KEY_READ = process.env.FRAPP_API_KEY_READ;
const FRAPP_API_KEY_REGISTER = process.env.FRAPP_API_KEY_REGISTER;
const FRAPP_API_KEY_UPDATE = process.env.FRAPP_API_KEY_UPDATE;
const FRAPP_API_KEY_FILTERS = process.env.FRAPP_API_KEY_FILTERS;
